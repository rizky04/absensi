      ...
      <div class="row">
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-height: 0.8rem;">
                        ...
                        {{$rekappresensi != null ? $rekappresensi->jmlhadir : 0}}
                        </span>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-height: 0.8rem;">
                        ...
                        <span style="font-size: 0.8rem; font-weight: 500;"><br>Izin</span>
                    </div>
                </div>
            </div>
            <div class="col-3">
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-height: 0.8rem;">
                        <span class="badge bg-danger" style="position: absolute; top:3px; right:10px; font-size:0.6rem;">
                            {{$rekappresensi != null ? $rekappresensi->jmlterlambat : 0}}
                        </span>
                    ...
                    <li>
                        <div class="item">
                            ...
                            <div class="in">
                                ...
                                <span class="badge badge-danger">{{ $d != null && $d->jam_out != null ? $d->jam_out : 'Belum Absen' }}</span>
                            </div>
                        </div>
                    </li>
                    @endforeach
